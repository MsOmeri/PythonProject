board = [' ' for x in range(10)] #we are going make the first value
#of our list an empty string, beacuse when we get input from user
#they will type 1-9 instead of 0-8
